...
class IIIF {
    ...
    public function buildMetadata () {
        ...
        $metadata = array(
            ...
            'Interviewees' => $this->markxpath->get_interviewees('//mods:name[mods:role[mods:roleTerm[@valueURI="http://id.loc.gov/vocabulary/relators/ive"]]]/mods:namePart'),
            'Interviewers' => $this->markxpath->get_interviewees('//mods:name[mods:role[mods:roleTerm[@valueURI="http://id.loc.gov/vocabulary/relators/ivr"]]]/mods:namePart'),
